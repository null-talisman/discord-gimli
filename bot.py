...
async def on_message(message):
        ...
        if message.content == 'weeb!':
            ...
            if random_int == 2:
                ...
                await message.channel.send(response)
                await message.channel.send(file=discord.File('test2.jpg'))
            if random_int == 3:
                response = 'Notice me senpai!'
                await message.channel.send(response)
                await message.channel.send(file=discord.File('test3.jpg'))
            if random_int == 4:
                response = 'Ughhhh senpai!'
                await message.channel.send(response)
                await message.channel.send(file=discord.File('test4.jpg'))
            if random_int == 5:
                response = 'What do you want for Christmas? What do you *really* want?'
                await message.channel.send(response)
                await message.channel.send(file=discord.File('test5.jpg'))
            if random_int == 6:
                response = 'Oh you need a hand with THAT? Well alright...'
                await message.channel.send(response)
                await message.channel.send(file=discord.File('test6.jpg'))
            if random_int == 7:
                response = 'I hope you don\'t mind that I brought a friend.'
                await message.channel.send(response)
                await message.channel.send(file=discord.File('test7.jpg'))
            if random_int == 8:
                response = 'Men never crave what they already have.'
                await message.channel.send(response)
                await message.channel.send(file=discord.File('test8.jpg'))
            if random_int == 9:
                response = 'What\'re you looking at, Curtis?'
                await message.channel.send(response)                
                await message.channel.send(file=discord.File('test9.jpg'))
            if random_int == 10:
                response = 'Meow...........meow'
                await message.channel.send(response)
                await message.channel.send(file=discord.File('test10.jpg'))
